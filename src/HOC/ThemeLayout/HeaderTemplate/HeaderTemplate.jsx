        ...
        return DanhSachLoaitKhach.map((Khach, index) => {
            ...
            const renderLoaiKhach = () => {
                return DanhSachLoaitKhach.map((Khach, index) => {
                    ...
                    const renderTongSoLuongKhach = datPhong.khach.reduce(
                        (total, item) => {
                    ...
                    const contentLoaitKhach = (
                        <div className="w-full">{renderLoaiKhach()}</div>
                    );
                    ...
                    const handleSearch = () => {
                        if (datPhong.idViTri.trim() !== "") {
                            localSearchStorageService.setSearchInfoLocal(
                                datPhong
                            );
                            navigate(`/search/${datPhong.idViTri}`);
                        } else {
                            message.error(
                                "Vui lòng chọn địa điểm bạn muốn tìm phòng"
                            );
                        }
                    };
                        ...
                        <div className="col-span-3 flex justify-end">
                            ...
                            <div>
                                <Popover
                                    ...
                                    content={
                                        <a onClick={hide}>{contentMenuBar}</a>
                                    }
                                    trigger="click"
                                    visible={visible}
