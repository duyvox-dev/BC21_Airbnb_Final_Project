...
export default function SearchForm({ ThongTinTimPhong }) {
    ...
    const ThayDoiSoLuongLoaiKhach = (customer, giaTri) => {
        let indexCustomerType = formik.values.customerInfo.findIndex((item) => {
            //Tìm index object loại khách đang thay đổi số lượng
            return item.customerType === customer;
        });
        let updateCustomerNumber = JSON.parse(
            JSON.stringify(formik.values.customerInfo)
        );
        if (indexCustomerType !== -1) {
            //Thay đổi số lượng loại khách đã xác định
            ...
            return (
                ...
                >
                    <div className="col-span-2 flex flex-wrap align-middle">
                        <p className="w-full my-auto font-bold">
                            {Khach.customerType}
                        </p>
            ...
            <Tabs defaultActiveKey="1" centered>
                <TabPane tab={<b>Chỗ ở</b>} key="1">
                    <div className="search-bar-container">
                        <div
                            className="search-bar-inner w-full flex flex-wrap justify-center
                        ...
                        >
                            ...
                            <div
                                className="date-input-block bg-transparent cursor-pointer w-full mt-5 flex flex-wrap justify-center
                            ...
                            >
                                <div
                                    className="date-input-item w-6/12 flex justify-center
                                lg:py-2 lg:relative lg:flex-none
                                md:py-2 md:relative md:flex-none"
                                >
                                    <span
                                        className="date-input-name w-full pointer-events-none text-lg font-bold text-center
                                ...
                                <RangePicker
                                    ...
                                    defaultValue={
                                        formik.values.bookingDate.checkIn !==
                                            null &&
                                        formik.values.bookingDate.checkOut !==
                                            null //Nếu localStorage chưa nhận giá trị thì trả ra string rỗng
                                            ? _.trim(
                            ...
                            <div
                                className="cursor-pointer w-full mt-5 flex flex-wrap justify-center
                ...
                <TabPane tab={<b>Trải nghiệm</b>} key="2"></TabPane>
            </Tabs>
        </div>
    );
}
