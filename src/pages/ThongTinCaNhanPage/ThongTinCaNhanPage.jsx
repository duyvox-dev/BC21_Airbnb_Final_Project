...
export default function ThongTinCaNhanPage(props) {
  ...
  return (
    ...
    >
      <div
        className="w-full lg:col-span-3 md:col-span-4"
      >
        <div
          className="mx-auto bg-white lg:w-11/12 lg:p-5 lg:border lg:border-gray-300 lg:rounded-2xl md:w-11/12 md:p-5 md:border md:border-gray-300 md:rounded-2xl"
        >
          ...
          <div className="mt-5">
            <div className="w-11/12 mx-auto">
              <img src={xacMinhDanhTinhIcon} className="w-8 lg:w-8 md:w-5" />
              ...
              <button
                className="px-2 py-1 font-bold border border-gray-800 rounded-lg hover:bg-gray-200 lg:py-2 lg:px-4 md:py-2 md:px-4"
              >
                Nhận huy hiệu
              </button>
            </div>
            ...
            <div
              className="w-11/12 mx-auto mt-2 lg:mt-5 lg:pt-5 lg:border-t lg:border-t-gray-300 md:mt-5 md:pt-5 md:border-t md:border-t-gray-300"
            >
      ...
      <div
        className="w-full my-5 lg:col-span-9 md:col-span-8"
      >
        <div
          className="w-full lg:p-2 md:p-2"
        >
          <div
            className="w-full lg:mb-10 md:mb-10"
          >
            <h1
              className="my-auto text-2xl font-bold text-center lg:text-4xl md:text-2xl"
            >
              Xin chào, tôi là {thongTinNguoiDung.name}
            </h1>
            <p
              className="my-auto text-center text-gray-500 lg:text-base md:text-base"
            >
          ...
          <div className="flex justify-between mt-5">
            <div
              className="w-full lg:mb-10 lg:pb-5 lg:border-b lg:border-b-gray-300 md:mb-10 md:pb-5 md:border-b md:border-b-gray-300 "
            >
              <FontAwesomeIcon icon={faStar} className="lg:mb-1 md:mb-1" />{" "}
              <span
                className="my-auto font-bold text-center lg:text-2xl md:text-2xl"
              >
                0 đánh giá
              </span>
            </div>
            ...
            >
              <p
                className="my-auto font-bold text-center underline cursor-pointer hover:text-gray-500 lg:text-base md:text-base"
              >
                Đánh giá của bạn
              </p>
            </div>
