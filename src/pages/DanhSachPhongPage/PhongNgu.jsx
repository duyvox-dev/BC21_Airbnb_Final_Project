  ...
  return (
    <div className="py-8 border-b">
      ...
      <div className="flex justify-start p-4 space-x-4">
        <button className="font-medium py-2 px-5 border rounded-2xl hover:border-black active:bg-black active:text-white focus:bg-black focus:text-white transition-all duration-300">
          Bất kì
        </button>
        {renderSoLuongKhach()}
      </div>
