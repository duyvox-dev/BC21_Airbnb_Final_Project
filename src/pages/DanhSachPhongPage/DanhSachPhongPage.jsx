            ...
            return (
                ...
                >
                    <div className="overflow-hidden rounded-lg shadow">
                        <img
                            className="w-full hover:scale-110 transition-all duration-300 object-cover lg:min-h-[200px]"
                            src={item.image}
                            alt={item.image}
                        />
                    </div>
                    <div className="mt-2 ">
                        <div className="sm:text-lg text-[16px] font-bold">
                            {item.name}
                        </div>
                        <div
                            style={{
                ...
                <div className="container px-3 mx-auto pt-52">
                    {danhSachPhong?.length > 0 ? (
                        ...
                        <div className="text-2xl font-bold">
                            Hiện tại không có phòng phù hợp, vui lòng quay lại
                            sau.
                        </div>
                    )}
                </div>
