...
import viTriSlice, { layDanhSachViTri, layDanhSachViTriDanhGiaCao } from "../../redux/viTriSlice";
import { useDispatch, useSelector } from "react-redux";
import { viTriService } from "../../services/viTriService";
import _ from 'lodash';
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faChevronCircleLeft, faChevronCircleRight, faLocationDot, faMapLocationDot } from "@fortawesome/free-solid-svg-icons";
...
export default function HomePage() {
    ...
    let deXuatDanhSachPhongDaNang = danhSachPhong.filter(item => item.locationId?.province == 'Đà Nẵng');
    ...
    return <div className='homepage w-full'>
